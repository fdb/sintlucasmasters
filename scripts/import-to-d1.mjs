...
function projectToSql(project) {
  return `INSERT OR REPLACE INTO projects (
    ...
    print_image_path, print_image_width, print_image_height, print_caption, print_description, print_language,
    ...
    NULL, NULL, NULL, ${sqlEscape(project.print_caption)}, ${sqlEscape(project.print_description)}, ${sqlEscape(project.print_language)},
