...
export const E2E_PROJECTS = [
  ...
  // --- Site filter coverage: published projects in CURRENT_YEAR (2025-2026)
  // for each programme that has a primary site. Used by E2E tests that drive
  // the multi-domain filter via ?__site=fotografie / ?__site=graduates.
  {
    id: "e2e-project-photo-2025",
    slug: "frida-lens",
    student_name: "Frida Lens",
    sort_name: "Lens, Frida",
    project_title_en: "Long Shadows",
    project_title_nl: "Lange Schaduwen",
    program: "BA_FO",
    // BA_FO has no context taxonomy in the new URL scheme, but the legacy
    // schema still requires the column to be set on render. Use "autonomous"
    // for parity with other published BA_FO seed rows.
    context: "autonomous",
    academic_year: "2025-2026",
    bio_en: "Frida photographs the slow change of light through cities.",
    bio_nl: "Frida fotografeert de trage verandering van licht in steden.",
    description_en: "A series on the way evening light reorganizes the city.",
    description_nl: "Een reeks over hoe avondlicht de stad opnieuw ordent.",
    status: "published",
    tags: '["photography"]',
    user_id: null,
  },
  {
    id: "e2e-project-prema-2025",
    slug: "milo-thread",
    student_name: "Milo Thread",
    sort_name: "Thread, Milo",
    project_title_en: "Premaster Sketches",
    project_title_nl: "Premasterschetsen",
    program: "PREMA_BK",
    context: "autonomous",
    academic_year: "2025-2026",
    bio_en: "Milo is preparing for the master programme.",
    bio_nl: "Milo bereidt zich voor op de masteropleiding.",
    description_en: "Sketches and studies leading into the autonomous context.",
    description_nl: "Schetsen en studies die leiden tot de autonome context.",
    status: "published",
    tags: '["sketches"]',
    user_id: null,
  },
  {
    ...
    print_image_path: "slam/testing/print-images/25-26/submit-student.jpg",
  ...
  },
  {
    ...
    print_image_path: "slam/testing/print-images/25-26/review-student.jpg",
